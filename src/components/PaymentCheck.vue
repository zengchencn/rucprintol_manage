...
export default {
  ...
  methods: {
    onQuery() {
      let self = this;
      fly
        .post("http://rucprint.cn:5000/querypayment", {
          order_date:
    ...
    check(id) {
      let self = this;
      fly
        .post("http://rucprint.cn:5000/checkpayment", {
          order_id: id
        })
        .then(() => {
          self.onQuery();
    ...
    trash(id) {
      let self = this;
      fly
        .post("http://rucprint.cn:5000/trash", {
          order_id: id
        })
        .then(() => {
          self.onQuery();
    ...
    //     Object.assign(this.order_data[this.editedIndex], this.editedItem);
    //   } else {
    //     this.order_data.push(this.editedItem);
    //   }
    //   this.close();
    // }
  }
